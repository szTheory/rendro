...
- 2026-05-23 [Docs]: Split user-flow/JTBD documentation into one public guide plus one internal delta/planning memo — keeps the public story readable for adopters while preserving future roadmap and refresh detail in planning artifacts.
