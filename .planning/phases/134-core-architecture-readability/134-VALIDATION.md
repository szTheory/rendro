...
| 134-03-03 | 03 | 3 | ARCH-01, ARCH-03 | T-134-06, T-134-07 | Remaining three recipe migrations retain exact deterministic, option, and failure contracts | render/contract | focused byte-identity and opts-threading tests for Ticket, Statement, and Certificate plus palette/themed smoke | ✅ | ⬜ pending |
| 134-04-01 | 04 | 4 | ARCH-02, ARCH-04 | T-134-08 | Bounded narration/spec/doc/comment audit preserves accurate contracts and operational provenance without speculative repair | governance/docs/static/type | `mix quality.governance && mix docs --warnings-as-errors && mix credo --strict && mix dialyzer` | ✅ infrastructure | ⬜ pending |
| 134-04-02 | 04 | 4 | ARCH-01, ARCH-02, ARCH-03, ARCH-04 | T-134-09 | Original finding lifecycles close only with focused, manifest, rendered-byte, docs/type/static, governance, and full-CI proof | terminal | `mix test test/rendro/public_api/manifest_test.exs test/docs_contract/public_api_contract_test.exs test/rendro/recipes/*_byte_identity_test.exs test/rendro/recipes/themed_render_smoke_test.exs && mix docs --warnings-as-errors && mix credo --strict && mix dialyzer && mix quality.governance && mix ci.fast` | ✅ infrastructure | ⬜ pending |
