...
- [x] `test/rendro/theme/preset_accent_golden_test.exs` — bounded `from_brand`/preset × accent byte goldens for POLISH-04.
- [x] `test/rendro/recipes/branded_invoice_typography_test.exs` — dedicated BrandedInvoice materialized typography contract.
- [x] `test/rendro/recipes/payslip_typography_test.exs` — dedicated Payslip materialized typography and fallback contract.
- [x] `test/rendro/recipes/receipt_typography_test.exs` — dedicated Receipt materialized typography contract.
- [x] Focused assertions in the existing Invoice, Statement, Certificate, and Ticket typography modules for scale, font roles, leading, and explicit override precedence.
