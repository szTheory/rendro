...
**Phase numbering:** sequential and continuous across milestones (never restarts at 01). v2.7 closed at phase 92; the next milestone starts at phase 93.
...
No active milestone is selected. Start the next planning cycle with `$gsd-new-milestone`.

Global Text Shaping & Script Support remains conditional and should be pursued only when the `ADOPTION.md` demand gate triggers.

---
*v2.7 shipped 2026-06-13 as Page Context & Browser Proof Hardening. Global text shaping remains demand-gated by ADOPTION.md.*
