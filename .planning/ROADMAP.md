...
- [ ] **Phase 132: Quality Baseline & Triage** — Establish the durable evidence ledger, compatibility contract, and risk-ranked finding set that governs all later work.
...
|-------|--------------|----------------|--------|-----------|
| 132. Quality Baseline & Triage | 4 | 0/TBD | Not started | — |
| 133. Repository & Evidence Hygiene | 4 | 0/TBD | Not started | — |
