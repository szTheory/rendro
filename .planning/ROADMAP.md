...
- [ ] 131-02-PLAN.md — Repair both protected workflow version parsers and lock their deterministic regression contracts.

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 131-03-PLAN.md — Prepare and fully validate one private exact v1.3.1 version/docs/package/verifier candidate.

**Wave 4** *(blocked on Wave 3 completion)*

- [ ] 131-04-PLAN.md — Obtain fresh exact-candidate approval, publish only through protected v1.3.1 paths, and verify every public prerequisite.

**Wave 5** *(blocked on Wave 4 completion)*

- [ ] 131-05-PLAN.md — Run the isolated exact-public-1.3.1 Phoenix journey and retain bounded dual-HTTP proof plus the failed v1.3.0 incident identity.
...
| 131. Adoption Snapshot & Phoenix Newcomer Proof | 1/5 | In Progress|  |
