...
- [x] **Phase 135: Test & CI/CD Simplification** — Preserve behavioral and authority coverage while consolidating brittle tests and milestone-specific workflow machinery. (completed 2026-08-27)
...
- [x] 135-03-PLAN.md — Record four same-SHA remote parity rows, then remove legacy routes in one rollback commit.
...
| 136. Catalog Visual Quality | 4 | 12/15 | In Progress|  |
