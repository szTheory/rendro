...
---
*Last updated: 2026-05-30 — started milestone v2.5 (1.0 Release Capstone). Current Milestone + Strategic Arc updated (Global Text Shaping renumbered to conditional v2.6); Active reset to v2.5 headline requirements (API/STAB/REL). Concrete REQ-IDs in `REQUIREMENTS.md`, phases 78–82 in `ROADMAP.md`. Prior milestone v2.4 archived in `milestones/v2.4-*`. Phase 78 complete (public API surface defined: hidden internals, tier tags + badges, `priv/public_api.json` manifest, uniform recipe opts). Next: `/gsd-discuss-phase 79` or `/gsd-plan-phase 79`.*
