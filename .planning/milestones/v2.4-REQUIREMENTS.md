...
- [x] **REF-02**: The reference app demonstrates the shipped recipes (Invoice, BrandedInvoice, Statement, Receipt/Report, Certificate) through `Rendro.Adapters.Phoenix`.
