...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 90-01-01 | 01 | 1 | DUP-03 | Invalid options | Malformed `only_on` and `page_numbering` raise before render | unit | `mix test test/rendro_builders_test.exs test/rendro/pipeline/compose_test.exs` | yes | pending |
| 90-01-02 | 01 | 1 | DUP-01, DUP-02 | Wrong parity | Running regions filter on physical odd/even pages and compose with section tokens | integration | `mix test test/rendro/pipeline/paginate_test.exs test/rendro/flow_test.exs` | yes | pending |
| 90-01-03 | 01 | 1 | DUP-01, DUP-02, DUP-03 | Contract drift | Public API manifest, focused tests, full suite, and formatting are green | contract/regression | `mix test test/rendro/public_api/manifest_test.exs test/docs_contract/public_api_contract_test.exs && mix test && mix format --check-formatted` | yes | pending |
