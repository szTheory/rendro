...
| Quick run command | Before public verification, use the existing focused release/verifier contracts named in `131-VALIDATION.md`; after Plan 10 creates the clean-room files, use `mix test test/docs_contract/adoption_evidence_contract_test.exs test/docs_contract/phoenix_newcomer_contract_test.exs test/scripts/phoenix_clean_room_proof_test.exs` |
