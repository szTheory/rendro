  ...
  defp manual_blocks do
    ([
       manual_page([
         ...
         body_text("The manual SHA-256 is published outside this PDF for byte checks."),
         body_text("Use this manual as a fit check; use HexDocs for API reference depth.")
       ]),
       manual_page([
         ...
         body_text("No arbitrary HTML/CSS rendering."),
         body_text("No blanket PDF/A or PDF/UA claim."),
         body_text("pdfium-render rasters are not GUI-viewer proof."),
       ...
       [
         [
           ...
           body_text("assets/rendro/artifacts.json records source PDF hashes and PNG hashes."),
           body_text("The manifest also records renderer metadata and the manual.pdf hash."),
