defmodule Rendro.Adapters.Oban.RenderWorker do
  ...
  This worker demonstrates how to integrate Rendro with Oban.
  Since Oban arguments must be JSON-serializable, this worker
  expects a callback module and arguments that can be used to
  ...
  if Code.ensure_loaded?(Oban) do
    ...
    def perform(%Oban.Job{args: %{"module" => module_str, "args" => args, "output_path" => path}}) do
      ...
      # The callback module should implement a build_document/1 function
